...
-- https://github.com/hughfdjackson/calculator/blob/master/src/Main.hs
-- Requires the LANGUAGE instruction to run in current Haskell, it seems.
-- Runs, but TODO: Requires an evaluation function.
